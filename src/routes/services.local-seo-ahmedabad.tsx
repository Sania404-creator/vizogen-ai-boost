...
const config = locationBySlug["ahmedabad"]!;
const url = "https://www.vizogen.in/services/local-seo-ahmedabad";

export const Route = createFileRoute("/services/local-seo-ahmedabad")({
  head: () => ({
    meta: [
