...
const config = locationBySlug["lucknow"]!;
const url = "https://www.vizogen.in/services/local-seo-lucknow";

export const Route = createFileRoute("/services/local-seo-lucknow")({
  head: () => ({
    meta: [
