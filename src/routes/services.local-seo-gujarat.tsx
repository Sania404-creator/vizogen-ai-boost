...
const config = locationBySlug["gujarat"]!;
const url = "https://www.vizogen.in/services/local-seo-gujarat";

export const Route = createFileRoute("/services/local-seo-gujarat")({
  head: () => ({
    meta: [
