...
const config = locationBySlug["rajkot"]!;
const url = "https://www.vizogen.in/services/local-seo-rajkot";

export const Route = createFileRoute("/services/local-seo-rajkot")({
  head: () => ({
    meta: [
