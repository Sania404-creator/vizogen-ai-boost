...
function buildEntries(): SitemapEntry[] {
  const entries: SitemapEntry[] = [
    ...
    { path: "/partner/affiliate-partner", changefreq: "monthly", priority: "0.8" },
    { path: "/partner/prime-plus-partner", changefreq: "monthly", priority: "0.8" },
    { path: "/partner/white-labelled-partner", changefreq: "monthly", priority: "0.8" },
