...
const config = locationBySlug["hyderabad"]!;
const url = "https://seo.vizogen.in/services/local-seo-hyderabad";

export const Route = createFileRoute("/services/local-seo-hyderabad")({
  head: () => ({
    meta: [
