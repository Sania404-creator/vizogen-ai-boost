...
const config = locationBySlug["udaipur"]!;
const url = "https://www.vizogen.in/services/local-seo-udaipur";

export const Route = createFileRoute("/services/local-seo-udaipur")({
  head: () => ({
    meta: [
