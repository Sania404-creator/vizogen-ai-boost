...
const config = locationBySlug["jaipur"]!;
const url = "https://seo.vizogen.in/services/local-seo-jaipur";

export const Route = createFileRoute("/services/local-seo-jaipur")({
  head: () => ({
    meta: [
