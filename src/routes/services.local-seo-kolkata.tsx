...
const config = locationBySlug["kolkata"]!;
const url = "https://www.vizogen.in/services/local-seo-kolkata";

export const Route = createFileRoute("/services/local-seo-kolkata")({
  head: () => ({
    meta: [
