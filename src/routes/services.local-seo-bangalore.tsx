...
const config = locationBySlug["bangalore"]!;
const url = "https://seo.vizogen.in/services/local-seo-bangalore";

export const Route = createFileRoute("/services/local-seo-bangalore")({
  head: () => ({
    meta: [
