...
const config = locationBySlug["gurgaon"]!;
const url = "https://www.vizogen.in/services/local-seo-gurgaon";

export const Route = createFileRoute("/services/local-seo-gurgaon")({
  head: () => ({
    meta: [
