/* Static-export replacement for the pricing section.
 * Same markup/design as the app version, but the currency + billing toggles are
 * driven by data attributes that assets/app.js reads (no React state). */
...
export function SubscriptionPlans({
  ...
  return (
    <section id="pricing" className="relative overflow-hidden py-20 sm:py-24" data-pricing>
      <div
        aria-hidden
              ...
              >
                ...
                <div className="mt-6 flex items-end gap-2">
                  <span
                    ...
                    data-price-inr-yearly={planPrice(plan, "yearly", "INR")}
                    data-price-inr-quarterly={planPrice(plan, "quarterly", "INR")}
                    data-price-usd-yearly={planPrice(plan, "yearly", "USD")}
                    data-price-usd-quarterly={planPrice(plan, "quarterly", "USD")}
                  >
                    {planPrice(plan, "yearly", "INR")}
                  </span>
                  <span className="pb-1 text-sm font-medium text-muted-foreground" data-period>
                    /year
                  </span>
                </div>
  ...
  return (
    <Reveal className="mx-auto mt-16 max-w-3xl">
      ...
      <Accordion className="mt-6 w-full">
        {pricingFaqs.map((f) => (
          <AccordionItem key={f.q} className="border-border/70">
